...
// --Second row --
const secondImgRow2 = document.querySelector("#secondrow img:last-child");
...
// -- Tenth row --
const tenthrowImages = document.querySelectorAll('#tenthrow img:nth-child(3n-1)');
const tenthBtn = document.querySelector('#tenthrow button');

tenthBtn.addEventListener('click', () => {
  tenthrowImages.forEach(img => {
     if (img.src.includes("cat-image.jpg")) {
       img.src = "./cat-image-changed.jpg";
       tenthBtn.textContent = "Hidden";
       tenthBtn.style.background = "green";
     } else {
       img.src = "./cat-image.jpg";
       tenthBtn.textContent = "Show";
       tenthBtn.style.background = "blue";
     }
  })
});

// -- Eleventh row --
const eleventhrowImage = document.querySelectorAll('#eleventhrow img:nth-child(3)')[0];
const eleventhBtn = document.querySelector('#eleventhrow button');

eleventhBtn.addEventListener('click', () => {
  if (eleventhrowImage.src.includes("cat-image.jpg")) {
    eleventhrowImage.src = "./cat-image-changed.jpg";
    eleventhBtn.textContent = "Hidden";
    eleventhBtn.style.background = "green";
  } else {
    eleventhrowImage.src = "./cat-image.jpg";
    eleventhBtn.textContent = "Show";
    eleventhBtn.style.background = "blue";
  }
});
